...
import 'package:mcnmr_result_object_observer/BothObserverCombiner5.dart';

class BothObserverCombiner5Builder<A, B, C, D, E, F, G, H, I, J, K>
    extends StatefulWidget {
  final BothObserverCombiner5<A, B, C, D, E, F, G, H, I, J, K> observer;
  ...
  @override
  State<BothObserverCombiner5Builder<A, B, C, D, E, F, G, H, I, J, K>>
      createState() =>
          _BothObserverCombiner5BuilderState<A, B, C, D, E, F, G, H, I, J, K>();
}

class _BothObserverCombiner5BuilderState<A, B, C, D, E, F, G, H, I, J, K>
    extends State<
        BothObserverCombiner5Builder<A, B, C, D, E, F, G, H, I, J, K>> {
  A _lastAValue;
  B _lastBValue;
  C _lastCValue;
  D _lastDValue;
  ...
  void initState() {
    ...
    _lastKValue = widget.observer.value;
    ...
    if (widget.observeResultChange) {
      widget.observer
          .subscribeResult((value) => setState(() => _lastKValue = value));
    }
  }

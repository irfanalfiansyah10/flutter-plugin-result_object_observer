...
class ResultObserverCombiner8Builder<A, B, C, D, E, F, G, H, I> extends StatefulWidget {
  ...
  final Widget Function(BuildContext context, A resultA, B resultB, C resultC, D resultD, E resultE, F resultF, G resultG, H resultH, I subscriber) builder;
  ...
  @override
  State<ResultObserverCombiner8Builder<A, B, C, D, E, F, G, H, I>> createState() => _ResultObserverCombiner8BuilderState<A, B, C, D, E, F, G, H, I>();
}

class _ResultObserverCombiner8BuilderState<A, B, C, D, E, F, G, H, I> extends State<ResultObserverCombiner8Builder<A, B, C, D, E, F, G, H, I>> {
  A _lastAValue;
  B _lastBValue;
  C _lastCValue;
  D _lastDValue;
  ...
  Widget build(BuildContext context) {
    return widget.builder(context, _lastAValue, _lastBValue, _lastCValue, _lastDValue, _lastEValue, _lastFValue, _lastGValue, _lastHValue, _lastIValue);
  }
}

...
class ResultObserverCombiner5Builder<A, B, C, D, E, F> extends StatefulWidget {
  ...
  @override
  State<ResultObserverCombiner5Builder<A, B, C, D, E, F>> createState() =>
      _ResultObserverCombiner5BuilderState<A, B, C, D, E, F>();
}

class _ResultObserverCombiner5BuilderState<A, B, C, D, E, F>
    extends State<ResultObserverCombiner5Builder<A, B, C, D, E, F>> {
  A _lastAValue;
  B _lastBValue;
  C _lastCValue;
  D _lastDValue;

...
class ResultObserverCombiner4Builder<A, B, C, D, E> extends StatefulWidget {
  ...
  final Widget Function(A resultA, B resultB, C resultC, D resultD, E subscriber) builder;
  ...
  @override
  State<ResultObserverCombiner4Builder<A, B, C, D, E>> createState() => _ResultObserverCombiner4BuilderState<A, B, C, D, E>();
}

class _ResultObserverCombiner4BuilderState<A, B, C, D, E> extends State<ResultObserverCombiner4Builder<A, B, C, D, E>> {
  A _lastAValue;
  B _lastBValue;
  C _lastCValue;
  D _lastDValue;
  ...
  Widget build(BuildContext context) {
    return widget.builder(_lastAValue, _lastBValue, _lastCValue, _lastDValue, _lastEValue);
  }
}

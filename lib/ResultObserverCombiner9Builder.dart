...
class ResultObserverCombiner9Builder<A, B, C, D, E, F, G, H, I, J>
  ...
  @override
  State<ResultObserverCombiner9Builder<A, B, C, D, E, F, G, H, I, J>>
      createState() =>
          _ResultObserverCombiner9BuilderState<A, B, C, D, E, F, G, H, I, J>();
}

class _ResultObserverCombiner9BuilderState<A, B, C, D, E, F, G, H, I, J>
    extends State<
        ResultObserverCombiner9Builder<A, B, C, D, E, F, G, H, I, J>> {
  A _lastAValue;
  B _lastBValue;
  C _lastCValue;
  D _lastDValue;
  ...
  void initState() {
    ...
    if (widget.observeResultIChange) {
      widget.observer
          .subscribeI((value) => setState(() => _lastIValue = value));
    }

    if (widget.observeResultChange) {
      widget.observer
          .subscribeResult((value) => setState(() => _lastJValue = value));
    }
  }
